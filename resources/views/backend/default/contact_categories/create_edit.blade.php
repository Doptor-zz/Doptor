                ...
                <div class="blue widget-title">
                    <h4>
                        ...
                        @if (!isset($contact_cat))
                            <span class="hidden-480">{!! trans('options.create_new') !!} {!! trans('fields.contact') !!} {!! trans('cms.category') !!}</span>
                        @else
                            <span class="hidden-480">{!! trans('options.edit') !!} {!! trans('fields.contact') !!} {!! trans('cms.category') !!}</span>
                        @endif
                        &nbsp;
                    </h4>
                </div>
