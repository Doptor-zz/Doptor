            ...
            <div class="widget box blue tabbable">
                <div class="blue widget-title">
                    <h4>
                        ...
                        @else
                            <span class="hidden-480">{!! trans('cms.edit') !!} {!! trans('cms.media_manager') !!}</span>
                        @endif
                        &nbsp;
                    </h4>
                </div>
                            ...
                            <div class="tab-pane active" id="widget_tab1">
                                ...
                                @if (!isset($media_entry))
                                    ...
                                    <div class="control-group {!! $errors->has('folder') ? 'error' : '' !!}">
                                        <label class="control-label">{!! trans('cms.current_folder') !!}</label>
                                        <div class="controls">
                                            ...
                                            <span class="help-inline">{!! trans('cms.drop_to_upload') !!}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div id="create-folder" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                                        <div class="modal-header">
                                            ...
                                            <h3 id="myModalLabel3">{!! trans('cms.create_new') !!} {!! trans('cms.folder') !!}</h3>
                                        </div>
                                        <div class="modal-body">
                                            <div class="control-group {!! $errors->has('folder') ? 'error' : '' !!}">
                                            <label class="control-label">{!! trans('cms.folder') !!} {!! trans('cms.name') !!}</label>
                                            <div class="controls">
                                                {!! Form::text('folder_name', '') !!}
                                                <span class="help-inline">{!! trans('cms.no_spaces_in_folder') !!}</span>
                                            </div>
                                        </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn" data-dismiss="modal" aria-hidden="true">{!! trans('cms.close') !!}</button>
                                            <button data-dismiss="modal" class="btn btn-primary" id="folder-submit">{!! trans('cms.confirm') !!}</button>
                                        </div>
                                    </div>
                                @else
