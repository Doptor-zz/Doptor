    ...
    <div class="container">
        {!! Form::open(array('url'=>'login/admin', 'method'=>'POST', 'class'=>'form-signin')) !!}
            ...
            <div class="controls input-icon">
                ...
                {!! Form::text('username', Input::old('username'), array('class'=>'input-block-level', 'placeholder' => trans('cms.username'))) !!}
            </div>
            <div class="controls input-icon">
                <i class=" icon-key"></i>
                {!! Form::password('password', array('class'=>'input-block-level', 'placeholder' => trans('cms.password'))) !!}
            </div>
