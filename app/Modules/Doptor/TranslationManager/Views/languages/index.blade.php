                        ...
                        <tbody>
                            @foreach ($languages as $language)
                                <tr>
                                    ...
                                    <td>{!! $language->code !!}</td>
                                    <td>
                                        {!! link_to_route('backend.modules.doptor.translation_manager.index', 'Manage', [$language->id]) !!}
                                        |
                                        {!! link_to_route('backend.modules.doptor.translation_manager.export', 'Export', [$language->id]) !!}
                                    </td>
                                    <td>
                                    @if ($language->id != 1)
