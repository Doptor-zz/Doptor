...
(9, 'Welcome', 'welcome', NULL, '<p>The CMS public section can now be viewed at {{ HTML::link(url(''/''), url(''/'')) }}</p>\n\n                    <p>The CMS admin can now be viewed at {{ HTML::link(url(''admin''), url(''admin'')) }}</p>\n\n                    <p>The CMS backend can now be viewed at {{ HTML::link(url(''backend''), url(''backend'')) }}</p>', 'published', 'public', 0, NULL, NULL, NULL, NULL, NULL, 'page', 0, 1, NULL, '2014-03-29 16:00:00', '2014-03-29 16:00:00', NULL),
