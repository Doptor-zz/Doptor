                            ...
                            @foreach ($forms as $i => $form)
                                <div class="tab-pane {{ $i==0 ? 'active' : '' }}" id="tab_{{ $i }}">
                                    <div class="clearfix margin-bottom-10">
                                        ...
                                        <div class="btn-group pull-right">
                                            <a href="{{ URL::to('admin/modules/'.$module_link.'/create/'.$form['form_id']) }}" class="btn btn-success">
                                        ...
                                        <tbody>
                                            @foreach ($form['entries'] as $entry)
                                                <tr>
                                                    ...
                                                    @endforeach
                                                    <td>
                                                        <a href="{{ URL::to('admin/modules/' . $module_link .'/' . $entry->id . '/edit/' . $form['form_id']) }}" class="btn btn-mini"><i class="icon-edit"></i></a>
