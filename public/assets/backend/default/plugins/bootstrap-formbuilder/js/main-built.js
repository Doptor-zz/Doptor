...
(function(e, t) {
    ...
    ut.fn = ut.prototype = {
        ...
        if ($.addEventListener) $.addEventListener("DOMContentLoaded", wt, !1), e.addEventListener("load", ut.ready, !1);
        else {
...
function() {
...
}), define("text!templates/snippet/textinputmulti.html", [], function() {
    return '<!-- Text input-->\n\n	<div class="control-group">\n	  <label class="control-label" for="<%= id %>"><%= label %></label>\n	  <div class="controls controls-row">\n\n		<input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= input1placeholder %>" class="<%= input1inputsize %> span5" <% if(input1required) {%> required <% } %> />\n\n\n		<input id="<%= id2 %>" name="<%= id2 %>" type="text" placeholder="<%= input2placeholder %>" class="<%= input2inputsize %> span5" <% if(input2required) {%> required <% } %> />\n\n\n	  </div>\n	</div>\n\n'
}), define("text!templates/snippet/textinputmulti2.html", [], function() {
    return '<!-- Text input-->\n\n	<div class="control-group">\n	  <label class="control-label" for="<%= id %>"><%= label %></label>\n	  <div class="controls controls-row">\n\n		<input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= input1placeholder %>" class="<%= input1inputsize %> span3" <% if(input1required) {%> required <% } %> />\n\n\n		<input id="<%= id2 %>" name="<%= id2 %>" type="text" placeholder="<%= input2placeholder %>" class="<%= input2inputsize %> span3" <% if(input2required) {%> required <% } %> />\n\n		<input id="<%= id3 %>" name="<%= id3 %>" type="text" placeholder="<%= input3placeholder %>" class="<%= input3inputsize %> span3" <% if(input3required) {%> required <% } %> />\n\n	  </div>\n	</div>\n\n'
}), define("text!templates/snippet/multiselectbasic.html", [], function() {
    return '<!-- Select Basic -->\n<div class="control-group">\n  <label class="control-label" for="<%= id %>"><%= label %></label>\n  <div class="controls controls-row">\n    <select id="<%= id %>" name="<%= id %>" class="<%= selectbasic1inputsize %> span5"><% _.each(selectbasic1options, function(option) { %>\n      <option><%= option %></option><% }); %>\n    </select>\n\n    <select id="<%= id2 %>" name="<%= id2 %>" class="<%= selectbasic2inputsize %> span5"><% _.each(selectbasic2options, function(option) { %>\n      <option><%= option %></option><% }); %>\n    </select>\n\n  </div>\n</div>\n'
}), define("text!templates/snippet/floatbutton.html", [], function() {
    return "<!-- Button -->\n    <button id=\"<%= id %>\" name=\"<%= id %>\" class='btn <%= buttontype %> pull-left' style='margin:5px 8px;' ><%= buttonlabel %></button>\n\n\n"
}), define("text!templates/snippet/textinputsingle.html", [], function() {
    return '<input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= placeholder %>" class="<%= inputsize %> pull-left" style="margin:5px 8px;" <% if(required) {%> required <% } %> />\n\n'
}), define("text!templates/snippet/selectbasicsingle.html", [], function() {
    return '<select id="<%= id %>" name="<%= id %>" class="<%= inputsize %> pull-left" style="margin:5px 8px;" ><% _.each(options, function(option) { %>\n      <option><%= option %></option><% }); %>\n</select>\n'
}), define("text!templates/snippet/textareasingle.html", [], function() {
    return '<textarea id="<%= id %>" name="<%= id %>" class="pull-left" style="margin:5px 8px; height:20px;" ><%= textarea %></textarea>\n'
}), define("text!templates/snippet/separator.html", [], function() {
    return '<hr style="float:none; width:100%; clear:both;" />'
}), define("text!templates/snippet/valuebox.html", [], function() {
    return '<input id="<%= id %>" name="<%= id %>" type="text" placeholder="<%= placeholder %>" value="<%= value %>" class="<%= inputsize %> pull-left" style="margin:5px 8px;" <% if(required) {%> required <% } %> />\n\n'
}), define("templates/snippet/snippet-templates", ["require", "text!templates/snippet/formname.html", "text!templates/snippet/prependedtext.html", "text!templates/snippet/searchinput.html", "text!templates/snippet/textinput.html", "text!templates/snippet/appendedcheckbox.html", "text!templates/snippet/appendedtext.html", "text!templates/snippet/filebutton.html", "text!templates/snippet/button.html", "text!templates/snippet/buttondouble.html", "text!templates/snippet/buttondropdown.html", "text!templates/snippet/multiplecheckboxes.html", "text!templates/snippet/multiplecheckboxesinline.html", "text!templates/snippet/multipleradios.html", "text!templates/snippet/multipleradiosinline.html", "text!templates/snippet/passwordinput.html", "text!templates/snippet/prependedcheckbox.html", "text!templates/snippet/prependedtext.html", "text!templates/snippet/searchinput.html", "text!templates/snippet/selectbasic.html", "text!templates/snippet/selectmultiple.html", "text!templates/snippet/textarea.html", "text!templates/snippet/textinput.html", "text!templates/snippet/textinputmulti.html", "text!templates/snippet/textinputmulti2.html", "text!templates/snippet/multiselectbasic.html", "text!templates/snippet/floatbutton.html", "text!templates/snippet/textinputsingle.html", "text!templates/snippet/selectbasicsingle.html", "text!templates/snippet/textareasingle.html", "text!templates/snippet/separator.html", "text!templates/snippet/valuebox.html"], function(e) {
    var t = e("text!templates/snippet/formname.html"),
        ...
        i = e("text!templates/snippet/textinput.html"),
        E = e("text!templates/snippet/textinputmulti.html"),
        S = e("text!templates/snippet/textinputmulti2.html"),
        x = e("text!templates/snippet/multiselectbasic.html"),
        T = e("text!templates/snippet/floatbutton.html"),
        N = e("text!templates/snippet/textinputsingle.html"),
        C = e("text!templates/snippet/selectbasicsingle.html"),
        k = e("text!templates/snippet/textareasingle.html"),
        L = e("text!templates/snippet/separator.html"),
        A = e("text!templates/snippet/valuebox.html");
    return {
        formname: t,
        prependedtext: n,
        search: r,
    ...
    return n.View.extend({
        tagName: "fieldset",
        initialize: function() {
            this.collection.on("add", this.render, this), this.collection.on("remove", this.render, this), this.collection.on("change", this.render, this), this.collection.on("add", this.toJson, this), this.collection.on("remove", this.toJson, this), this.collection.on("change", this.toJson, this), i.on("mySnippetDrag", this.handleSnippetDrag, this), i.on("tempMove", this.handleTempMove, this), i.on("tempDrop", this.handleTempDrop, this), this.$build = e("#build"), this.renderForm = t.template(s), this.render()
        },
        render: function() {
            this.$el.empty();
            var n = this;
        ...
        toJson: function() {
            e('#json-data').val(JSON.stringify(this.collection.toJSON()));
        },
    ...
    return '[\r\n  {\r\n    "title": "Select Basic",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "selectbasic"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select Basic"\r\n      },\r\n      "options": {\r\n        "label": "Options",\r\n        "type": "textarea-split",\r\n        "value": [\r\n          "Option one",\r\n          "Option two"\r\n        ]\r\n      },\r\n      "inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Multi Select Basic",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name 1",\r\n        "type": "input",\r\n        "value": "selectbasic1"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select Basic Multi"\r\n      },\r\n      "selectbasic1label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select 1"\r\n      },\r\n      "selectbasic1options": {\r\n        "label": "Options",\r\n        "type": "textarea-split",\r\n        "value": [\r\n          "Option one",\r\n          "Option two"\r\n        ]\r\n      },\r\n      "selectbasic1inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      },\r\n      "id2": {\r\n        "label": "ID / Name 2",\r\n        "type": "input",\r\n        "value": "selectbasic2"\r\n      },\r\n      "selectbasic2label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select Basic 2"\r\n      },\r\n      "selectbasic2options": {\r\n        "label": "Options",\r\n        "type": "textarea-split",\r\n        "value": [\r\n          "Option one",\r\n          "Option two"\r\n        ]\r\n      },\r\n      "selectbasic2inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Select Multiple",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "selectmultiple"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select Multiple"\r\n      },\r\n      "options": {\r\n        "label": "Options",\r\n        "type": "textarea-split",\r\n        "value": [\r\n          "Option one",\r\n          "Option two"\r\n        ]\r\n      },\r\n      "inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  }\r\n]'
}), define("text!data/buttons.json", [], function() {
    return '[\r\n  {\r\n    "title": "File Button",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "filebutton"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "File Button"\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Single Button",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "singlebutton"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Single Button"\r\n      },\r\n      "buttonlabel": {\r\n        "label": "Button Label",\r\n        "type": "input",\r\n        "value": "Button"\r\n      },\r\n      "buttontype": {\r\n        "label": "Button Type",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "btn-default",\r\n            "label": "Default",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-primary",\r\n            "label": "Primary",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "btn-info",\r\n            "label": "Info",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-success",\r\n            "label": "Success",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-warning",\r\n            "label": "Warning",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-danger",\r\n            "label": "Danger",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-inverse",\r\n            "label": "Inverse",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Double Button",\r\n    "fields": {\r\n      "id": {\r\n        "label": "Button 1 ID / Name",\r\n        "type": "input",\r\n        "value": "button1id"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Double Button"\r\n      },\r\n      "button1label": {\r\n        "label": "Button Label",\r\n        "type": "input",\r\n        "value": "Good Button"\r\n      },\r\n      "button1type": {\r\n        "label": "Button Type",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "btn-default",\r\n            "label": "Default",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-primary",\r\n            "label": "Primary",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-info",\r\n            "label": "Info",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-success",\r\n            "label": "Success",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "btn-warning",\r\n            "label": "Warning",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-danger",\r\n            "label": "Danger",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-inverse",\r\n            "label": "Inverse",\r\n            "selected": false\r\n          }\r\n        ]\r\n      },\r\n      "id2": {\r\n        "label": "Button 2 ID / Name",\r\n        "type": "input",\r\n        "value": "button2id"\r\n      },\r\n      "button2label": {\r\n        "label": "Button Label",\r\n        "type": "input",\r\n        "value": "Scary Button"\r\n      },\r\n      "button2type": {\r\n        "label": "Button Type",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "btn-default",\r\n            "label": "Default",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-primary",\r\n            "label": "Primary",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-info",\r\n            "label": "Info",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-success",\r\n            "label": "Success",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-warning",\r\n            "label": "Warning",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-danger",\r\n            "label": "Danger",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "btn-inverse",\r\n            "label": "Inverse",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  }\r\n]'
}), define("text!data/extras.json", [], function() {
    return '[\r\n  {\r\n    "title": "Float Button",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "floatbutton"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Float Button"\r\n      },\r\n      "buttonlabel": {\r\n        "label": "Button Label",\r\n        "type": "input",\r\n        "value": "Single Button"\r\n      },\r\n      "buttontype": {\r\n        "label": "Button Type",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "btn-default",\r\n            "label": "Default",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-primary",\r\n            "label": "Primary",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "btn-info",\r\n            "label": "Info",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-success",\r\n            "label": "Success",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-warning",\r\n            "label": "Warning",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-danger",\r\n            "label": "Danger",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "btn-inverse",\r\n            "label": "Inverse",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Separator"\r\n  },\r\n  {\r\n    "title": "Text Input Single",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "textinputsingle"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Text Input Single"\r\n      },\r\n      "placeholder": {\r\n        "label": "Placeholder",\r\n        "type": "input",\r\n        "value": "Single Input Small"\r\n      },\r\n      "helptext": {\r\n        "label": "Help Text",\r\n        "type": "input",\r\n        "value": "help"\r\n      },\r\n      "required": {\r\n        "label": "Required",\r\n        "type": "checkbox",\r\n        "value": false\r\n      },\r\n      "inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Separator"\r\n  },\r\n  {\r\n    "title": "Select Basic Single",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "selectbasicsingle"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Select Basic Single"\r\n      },\r\n      "options": {\r\n        "label": "Options",\r\n        "type": "textarea-split",\r\n        "value": [\r\n          "Option one",\r\n          "Option two"\r\n        ]\r\n      },\r\n      "inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Separator"\r\n  },\r\n  {\r\n    "title": "Text Area Single",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "textareasingle"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Text Area Single"\r\n      },\r\n      "textarea": {\r\n        "label": "Starting Text",\r\n        "type": "textarea",\r\n        "value": "Text Area Slim"\r\n      }\r\n    }\r\n  },\r\n  {\r\n    "title": "Separator"\r\n  },\r\n  {\r\n    "title": "Value Box",\r\n    "fields": {\r\n      "id": {\r\n        "label": "ID / Name",\r\n        "type": "input",\r\n        "value": "valuebox"\r\n      },\r\n      "label": {\r\n        "label": "Label Text",\r\n        "type": "input",\r\n        "value": "Value Box"\r\n      },\r\n      "placeholder": {\r\n        "label": "Placeholder",\r\n        "type": "input",\r\n        "value": "Value Box"\r\n      },\r\n      "value": {\r\n        "label": "Value",\r\n        "type": "input",\r\n        "value": "any"\r\n      },\r\n      "required": {\r\n        "label": "Required",\r\n        "type": "checkbox",\r\n        "value": false\r\n      },\r\n      "inputsize": {\r\n        "label": "Input Size",\r\n        "type": "select",\r\n        "value": [\r\n          {\r\n            "value": "input-mini",\r\n            "label": "Mini",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-small",\r\n            "label": "Small",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-medium",\r\n            "label": "Medium",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-large",\r\n            "label": "Large",\r\n            "selected": false\r\n          },\r\n          {\r\n            "value": "input-xlarge",\r\n            "label": "Xlarge",\r\n            "selected": true\r\n          },\r\n          {\r\n            "value": "input-xxlarge",\r\n            "label": "Xxlarge",\r\n            "selected": false\r\n          }\r\n        ]\r\n      }\r\n    }\r\n  }\r\n]'
}), define("text!templates/app/render.html", [], function() {
    return '<h3>Rendered source of your form:</h3>\n<textarea id="render" class="span" class="rendered"></textarea>\n'
    ...
    return {
        initialize: function() {
            new s({
                ...
                title: "About",
                content: p
            }), e("#components .tab-pane").first().addClass("active"), e("#formtabs li").first().addClass("active");
            if (e('#json-data').val() !== '') {
                form_data = JSON.parse(e('#json-data').val());
            } else {
                form_data = [{
                    "title": "Form Name",
                    "fields": {
